...
class ResidualBlock(tf.keras.Model):
    ...
    def __init__(self, filters, size, norm_axis=None):
        ...
        self.batchnorm1 = tf.keras.layers.BatchNormalization(axis=norm_axis)
        ...
        self.batchnorm2 = tf.keras.layers.BatchNormalization(axis=norm_axis)
...
class ResNet9Generator(tf.keras.Model):
    ...
    def __init__(self, noise=False):
        ...
        self.res1 = ResidualBlock(256, 3, norm_axis=3)
        self.res2 = ResidualBlock(256, 3, norm_axis=3)
        self.res3 = ResidualBlock(256, 3, norm_axis=3)
        self.res4 = ResidualBlock(256, 3, norm_axis=3)
        self.res5 = ResidualBlock(256, 3, norm_axis=3)
        self.res6 = ResidualBlock(256, 3, norm_axis=3)
        self.res7 = ResidualBlock(256, 3, norm_axis=3)
        self.res8 = ResidualBlock(256, 3, norm_axis=3)
        self.res9 = ResidualBlock(256, 3, norm_axis=3)
    ...
    def call(self, x, training):
        ...
        x5 = self.res2(x4, training=training)
        x6 = self.res3(x5, training=training)
        x7 = self.res4(x6, training=training)
        x8 = self.res5(x7, training=training)
        x9 = self.res6(x8, training=training)
        x10 = self.res7(x9, training=training)
        x11 = self.res8(x10, training=training)
        x12 = self.res9(x11, training=training)
        
        x13 = self.up1(x12, None, training=training) # (bs, 128, 128, 128)
        x14 = self.up2(x13, None, training=training) # (bs, 256, 256, 64)

        x15 = self.last(x14) # (bs, 256, 256, 3)
        x15 = tf.nn.tanh(x15)
...
class C_GAN():
    ...
    def __init__(self, generator, noise=False):
        self.name = generator + str(noise) + '_'
        self.generator = UNetGenerator(noise) if generator == 'unet' else ResNet9Generator(noise)
